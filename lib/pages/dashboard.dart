              ...
              child: Container(
                ...
                child: InkWell(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text("Expanded Widget",style: TextStyle(
                        fontSize:24.0,
                        color:Colors.purple,
                      )),
                      Padding(padding: EdgeInsets.all(5.0)),
                      Text("A widget that expands a child of a Row, Column, or Flex so that the child fills the available space",style: TextStyle(
                        fontSize:17.0,
                        color:Colors.black,
                      )),
                      Padding(padding: EdgeInsets.all(5.0),),
